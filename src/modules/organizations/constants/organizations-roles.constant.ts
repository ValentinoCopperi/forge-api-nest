...
export const ORGANIZATION_ROLES_DEFINITIONS: OrganizationRolesDefinitions = new Map([
    [OrganizationUserRole.OWNER, ["delete", "update", "add-user", "remove-user", "add-project", "remove-project", "update-user-role"]],
    [OrganizationUserRole.ADMIN, ["add-user", "remove-user", "add-project", "remove-project", "update-user-role"]],
