...
class OrganizationProjectResponseDto {
    @ApiProperty({ description: 'The id of the project', example: 1, type: Number })
    id: number;

    @ApiProperty({ description: 'The name of the project', example: 'My Project', type: String })
    name: string;
    ...
    @ApiProperty({ description: 'The created at date of the project', type: Date })
    createdAt: Date;
...
class OrganizationMemberResponseDto {
    @ApiProperty({ description: 'The id of the organization membership', example: 1, type: Number })
    id: number;
